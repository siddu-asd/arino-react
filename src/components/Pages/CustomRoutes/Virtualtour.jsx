...
const scenes = {
  ENTRY: {
    panorama: '/images/office-15.jpg',
    markers: [
      { id: 'TO-ROOM1', image: '/images/office-10.jpg', tooltip: 'Go to Office Room', position: { yaw: -3.0, pitch: -0.15 }, target: 'ROOM1' },
      { id: 'TO-STUDIO-OUTSIDE', image: '/images/office-6.jpg', tooltip: 'Go to Studio Entrance', position: { yaw: -2.0, pitch: -0.1 }, target: 'STUDIO-OUTSIDE' },
      { id: 'TO-NEW-OFFICE', image: '/images/office-11.jpg', tooltip: 'Go to New Office', position: { yaw: 1.5, pitch: 0.2 }, target: 'NEW-OFFICE' },
    ],
  },
  ROOM1: {
    panorama: '/images/office-10.jpg',
    markers: [
      { id: 'TO-ADMIN-BLOCK', image: '/images/office-14.jpg', tooltip: 'Go to Admin Block', position: { yaw: 2.5, pitch: -0.1 }, target: 'ADMIN-BLOCK' },
      { id: 'ROOM1-BACK', image: '/images/office-15.jpg', tooltip: 'Back to Main Entry', position: { yaw: -0.6, pitch: 0.1 }, target: 'ENTRY' },
    ],
  },
  'ADMIN-BLOCK': {
    panorama: '/images/office-14.jpg',
    markers: [
      { id: 'TO-MEETING-ROOM', image: '/images/office-7.jpg', tooltip: 'Go to Meeting Room', position: { yaw: -0.7, pitch: -0.1 }, target: 'MEETING-ROOM' },
      { id: 'TO-WORKSPACE-FROM-ADMIN', image: '/images/office-7.jpg', tooltip: 'Go to Workspace', position: { yaw: -0.4, pitch: 0.1 }, target: 'WORKSPACE' },
      { id: 'ADMIN-BLOCK-BACK', image: '/images/office-10.jpg', tooltip: 'Back to Office Room', position: { yaw: 2.6, pitch: -0.1 }, target: 'ROOM1' },
    ],
  },
  'MEETING-ROOM': {
    panorama: '/images/office-7.jpg',
    markers: [
      { id: 'MEETING-BACK', image: '/images/office-14.jpg', tooltip: 'Back to Admin Block', position: { yaw: -0.95, pitch: -0.25 }, target: 'ADMIN-BLOCK' },
    ],
  },
  'WORKSPACE': {
    panorama: '/images/office-2.jpg',
    markers: [
      { id: 'WORKSPACE-BACK', image: '/images/office-14.jpg', tooltip: 'Back to Admin Block', position: { yaw: -2.5, pitch: -0.1 }, target: 'ADMIN-BLOCK' },
    ],
  },
  'NEW-OFFICE': {
    panorama: '/images/office-11.jpg',
    markers: [
      { id: 'TO-NEW-OFFICE-INSIDE', image: '/images/office-12.jpg', tooltip: 'Go to New Office Interior', position: { yaw: -0.2, pitch: 0.1 }, target: 'NEW-OFFICE-INSIDE' },
      { id: 'NEW-OFFICE-BACK', image: '/images/office-15.jpg', tooltip: 'Back to Main Entry', position: { yaw: 1.5, pitch: 0.1 }, target: 'ENTRY' },
    ],
  },
  'NEW-OFFICE-INSIDE': {
    panorama: '/images/office-12.jpg',
    markers: [
      { id: 'NEW-OFFICE-INSIDE-BACK', image: '/images/office-11.jpg', tooltip: 'Back to New Office', position: { yaw: -3.55, pitch: -0.1 }, target: 'NEW-OFFICE' },
    ],
  },
  'STUDIO-OUTSIDE': {
    panorama: '/images/office-6.jpg',
    markers: [
      { id: 'TO-STUDIO', image: '/images/office-1.jpg', tooltip: 'Go to Studio', position: { yaw: 1.9, pitch: 0.05 }, target: 'STUDIO' },
      { id: 'STUDIO-OUTSIDE-BACK', image: '/images/office-15.jpg', tooltip: 'Back to Main Entry', position: { yaw: -0.6, pitch: 0.05 }, target: 'ENTRY' },
    ],
  },
  'STUDIO': {
    panorama: '/images/office-16.jpg',
    markers: [
      { id: 'STUDIO-BACK', image: '/images/office-6.jpg', tooltip: 'Back to Studio Entrance', position: { yaw: -2.19, pitch: -0.18 }, target: 'STUDIO-OUTSIDE' },
    ],
  },
};
...
const ViewerComponent = ({ toggleChatBot }) => {
  ...
  useEffect(() => {
    ...
    logoOverlay.innerHTML = `<img class="responsive-logo" src='/images/nisaa.png', alt="Logo" />`;
  ...
  return (
    <div>
      ...
      />
      {/* Always render VerticalNav so Explore button is always visible */}
